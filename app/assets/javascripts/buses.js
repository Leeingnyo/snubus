$(function (){
  ...
  */
  var stop_locations = {
    ...
    "34733": {"top": 21, "left": 72}, //에너지자원연구소
    "33748": {"top": 33, "left": 71}, //공대입구(하)
    "33749": {"top": 49, "left": 61}, //농생대(하)
    "33750": {"top": 61, "left": 49}, //자연대.행정관입구(하)
    "34732": {"top": 62, "left": 43}, //문화관입구
    "34043": {"top": 72, "left": 34}, //법대입구(하)
    "34731": {"top": 87, "left": 25}, //서울대정문(하)
    "3447": {"top": 92, "left": 17}, //서울대학교(하)

    //5511 Comming
    "34554": {"top": 92, "left": 17}, //서울대학교(상)
    "33753": {"top": 60, "left": 20}, //경영대(상)
    "34741": {"top": 45, "left": 18}, //수의대입구.보건대학원앞(상)
    "33744": {"top": 34, "left": 30}, //국제대학원(상)
    "10456": {"top": 13, "left": 42}, //관악사삼거리(상)
    "10452": {"top": 14, "left": 65}, //공동기기원(상)
    "33356": {"top": 13, "left": 73}, //유전공학연구소.반도체공동연구소(상)
    "34733": {"top": 21, "left": 72}, //에너지자원연구소
    "33354": {"top": 30, "left": 81}, //신소재
    ...
    "33355": {"top": 11, "left": 71}, //유전공학연구소,반도체공동연구소(하)
    "10459": {"top": 11, "left": 67}, //교수회관입구
    "10455": {"top": 15, "left": 39}, //관악사삼거리(하)
    "33709": {"top": 33, "left": 27}, //국제대학원(하)
    "36591": {"top": 51, "left": 16}, //수의대입구.보건대학원앞(하)
    "33707": {"top": 63, "left": 18}, //경영대(하)
    "3447": {"top": 92, "left": 17}, //서울대학교(하)

    //5513 Coming
    "34554": {"top": 92, "left": 17}, //서울대학교(상)
    "3446": {"top": 88, "left": 23}, //서울대정문(상)
    "33353": {"top": 73, "left": 35}, //법대입구(상)
    "34552": {"top": 62, "left": 48}, //자연대.행정관입구(상)
    "33352": {"top": 56, "left": 59}, //농생대(상)
    "33351": {"top": 34, "left": 73}, //공대입구(상)
    "33354": {"top": 30, "left": 81}, //신소재
    "36960": {"top": 14, "left": 93}, //건설환경종합연구소앞
    "35864": {"top": 8, "left": 90}, //제2공학관(착)
